...
# ALLOWED_HOSTS = []
ALLOWED_HOSTS = ["resume-project-ddar.onrender.com", "localhost", "127.0.0.1"]
CSRF_TRUSTED_ORIGINS = ["https://resume-project-ddar.onrender.com"]
...
EMAIL_HOST = 'smtp.web.de'  # 'smtp.gmail.com' / 'smtp.office365.com' / 'mail.gmx.net'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
